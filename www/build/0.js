webpackJsonp([0],Array(271).concat([
/* 271 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__patient_detail__ = __webpack_require__(396);
...
var PatientDetailPageModule = (function () {
...
PatientDetailPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_2__patient_detail__["a" /* PatientDetailPage */],
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__patient_detail__["a" /* PatientDetailPage */]),
        ],
    })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_moment__ = __webpack_require__(273);
...
var PatientDetailPage = (function (_super) {
    __extends(PatientDetailPage, _super);
    function PatientDetailPage(nav, navParams) {
        var _this = _super.call(this, "PatientDetail") || this;
        _this.nav = nav;
    ...
    PatientDetailPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad PatientDetailPage');
    };
    PatientDetailPage.prototype.formatAppointmentTime = function (appointment) {
        return __WEBPACK_IMPORTED_MODULE_3_moment__(appointment.scheduledTime).format("hh:mm a");
    };
    PatientDetailPage.prototype.getPatientAge = function (patient) {
        return __WEBPACK_IMPORTED_MODULE_3_moment__().diff(__WEBPACK_IMPORTED_MODULE_3_moment__(patient.dob), "years");
    };
    PatientDetailPage.prototype.getPatientLocationClass = function (appointment) {
    ...
    PatientDetailPage.prototype.formatVisitDate = function (visit) {
        return __WEBPACK_IMPORTED_MODULE_3_moment__(visit.date).format("MMM DD, YYYY");
    };
    PatientDetailPage.prototype.formatTestItemDate = function (dateStr) {
        if (!dateStr) {
            return "--";
        }
        return __WEBPACK_IMPORTED_MODULE_3_moment__(dateStr).format("YYYY/MM/DD");
    };
    PatientDetailPage.prototype.formatTestItemTime = function (dateStr) {
        if (!dateStr) {
            return " ";
        }
        return __WEBPACK_IMPORTED_MODULE_3_moment__(dateStr).format("@ hh:mm a");
    };
    PatientDetailPage.prototype.subscribeToTest = function (test) {
        WLAuthorizationManager.obtainAccessToken().then(function () {
            MFPPush.subscribe(["TEST-" + test.id], function () { console.log("Subscribed to tag TEST-" + test.id); }, function (error) { console.log("Error subscribing to tag TEST-" + test.id + ": " + JSON.stringify(error)); });
        });
    };
    PatientDetailPage.prototype.isSaveDisabled = function () {
        return !this._isDirty;
    };
    PatientDetailPage.prototype.onChange = function (event) {
        console.debug("onChange: event = %o", event);
        this._isDirty = true;
    };
    PatientDetailPage.prototype.saveChanges = function () {
        this._isDirty = false;
        // Put this in the JSONStore and send to server if connected
    };
    PatientDetailPage.prototype.setTab = function (newTab) {
