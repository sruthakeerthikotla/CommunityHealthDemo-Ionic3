webpackJsonp([1],Array(269).concat([
/* 269 */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__appointments__ = __webpack_require__(394);
...
var AppointmentsPageModule = (function () {
...
AppointmentsPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["L" /* NgModule */])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_2__appointments__["a" /* AppointmentsPage */],
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["f" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__appointments__["a" /* AppointmentsPage */]),
        ],
    })
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__providers_appointment_service_appointment_service__ = __webpack_require__(197);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_moment__ = __webpack_require__(273);
 ...
 */
var AppointmentsPage = (function (_super) {
    __extends(AppointmentsPage, _super);
    function AppointmentsPage(_nav, _appointmentService) {
        var _this = _super.call(this, "Appointments") || this;
        _this._nav = _nav;
    ...
    AppointmentsPage.prototype.needsDivider = function (appointment) {
        ...
        return !__WEBPACK_IMPORTED_MODULE_4_moment__(appointment.scheduledTime).isSame(this.appointments[index - 1].scheduledTime, "day");
    };
    AppointmentsPage.prototype.formatDividerDate = function () {
        ...
        return "Today - " + __WEBPACK_IMPORTED_MODULE_4_moment__().format("dddd, MMMM Do");
    };
    AppointmentsPage.prototype.formatAppointmentTime = function (appointment) {
        return __WEBPACK_IMPORTED_MODULE_4_moment__(appointment.scheduledTime).format("hh:mm a");
    };
    AppointmentsPage.prototype.openAppointmentDetails = function (appointment) {
        this._nav.push('AppointmentDetailPage', { appointment: appointment });
    };
    AppointmentsPage.prototype.logout = function () {
        var _this = this;
        if (WL.Client.getEnvironment() === "preview") {
            this._nav.popToRoot();
        }
        else {
            WLAuthorizationManager.logout("UserLoginSecurityCheck").then(function () { return _this._nav.popToRoot(); });
        }
    };
    AppointmentsPage.prototype.getPatientLocationClass = function (appointment) {
    ...
    AppointmentsPage.prototype.onPageDidEnter = function (hideSpinner) {
        var _this = this;
        if (hideSpinner === void 0) { hideSpinner = false; }
        _super.prototype.onPageDidEnter.call(this);
        ...
        this._appointmentService.load(__WEBPACK_IMPORTED_MODULE_2__parent_parent__["a" /* ParentPage */].fromPage == "Login" ? true : false).then(function (appointments) {
            _this.appointments = appointments;
            _this.loading = false;
            _this.loadingError = "";
            if (_this._refresher) {
                _this._refresher.complete();
                _this._refresher = null;
            }
        }, function (error) {
            _this.loading = false;
            _this.loadingError = "Something went wrong loading the list of appointments. Sorry! :(";
        });
    };
