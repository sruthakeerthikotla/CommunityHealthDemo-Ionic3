...
WL._JSONStoreImpl = (function(jQuery, underscore) {
  ...
  var db = WL.db || WL.browser,
    ...
    */
	...
	function actionReceiverForAddSync(received){
         ...
         {
               WL.App.addActionReceiver(syncActionReceiverName, actionReceiverForAddSync);
         }
	...
	if(check.isObject(options) && !check.isUndefined(options.syncAdapterPath) && check.isInt(options.syncAdapterPath)){
